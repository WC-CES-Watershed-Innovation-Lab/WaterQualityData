...
main.py is the main codefile that forms the basis of this repo's functionality. With that program, we pull data from HydroVu and compile them into PyPlot graphs. Then, the program uploads PyPlot graph bit data to this GitHub repo.
